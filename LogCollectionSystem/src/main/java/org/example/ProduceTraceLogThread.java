...
public class ProduceTraceLogThread implements Runnable {
    ...
    public ProduceTraceLogThread(Queue<Logger> queue) {
        this.queue = queue;
    }

    public ProduceTraceLogThread(Queue<Logger> queue, Count count) {
        this.queue = queue;
        this.count = count;
    }
    ...
    public void run() {
        for (int i = 0; i < 10; i++) {
            ...
            synchronized (logger.getClass()) {
                ...
                logger.setLogMsg("This is trace message.");
